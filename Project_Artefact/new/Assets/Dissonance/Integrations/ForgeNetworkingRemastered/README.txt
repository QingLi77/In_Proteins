Dissonance Forge Remastered Integration
=======================================

This package integrates Dissonance Voice Chat (https://assetstore.unity.com/packages/tools/audio/dissonance-voice-chat-70078?aid=1100lJDF) with the Forge Remastered (https://assetstore.unity.com/packages/tools/network/forge-networking-remastered-38344?aid=1100lJDF) networking system. To use this package you must have purchased and installed Dissonance and Forge Remastered - **you will encounter build errors until you have done this**!

The included demo scene (Assets/Dissonance/Integrations/ForgeNetworkingRemastered/Demo/Forge Remastered Game World) demonstrates the basics of a voice chat session running in a Forge Remastered network session. Consult the readme file in the demo folder for details on how to run the demo and what features it demonstrates.
